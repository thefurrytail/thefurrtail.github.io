...
(function ($) {
    $.fn.FacebookAlbumBrowser = function (options) {
        var defaults = {
            ...
            shareButton: true,
            addThis: null,
            pluginImagesPath: "fb_plugin/src/",
            albumsPageSize: 0,
        ...
        selector.each(function (index) {
            ...
            function initLightboxes(photoLink) {
                ...
                if (overlay.length == 0) {
                    ...
                    overlay.append($("<img>", { class: "fb-preview-img-prev", src: "fb_plugin/src/prev-icon.png" }));
                    overlay.append($("<img>", { class: "fb-preview-img-next", src: "fb_plugin/src/next-icon.png" }));
